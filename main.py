...
################################################
    ...
    def open_add_customer(self):
        ...
        # Replace the previous mix checkbox section with this updated one
# Inside your open_add_customer(self): method

# ... after creating entry_first_name, entry_last_name, entry_phone, and employee_combobox
...
# Auto focus chain
        ...
        # self.radio_sada = tk.Radiobutton(input_mix_frame, text="سادة", variable=self.mix_category, value="سادة", anchor="w", justify="right")
        # self.radio_sada.grid(row=0, column=0, padx=5)
        # self.radio_mehaweg = tk.Radiobutton(input_mix_frame, text="محوج", variable=self.mix_category, value="محوج", anchor="w", justify="right")
        # self.radio_mehaweg.grid(row=0, column=1, padx=5)
        # self.radio_ispresso = tk.Radiobutton(input_mix_frame, text="اسبريسو", variable=self.mix_category, value="اسبريسو", anchor="w", justify="right")
        # self.radio_ispresso.grid(row=0, column=2, padx=5)
        # lbl_mix_details = tk.Label(input_mix_frame, text="التوليفة:", anchor="e", width=8 ,bg="#FFD65A")




        # chk_sada = tk.Checkbutton(input_mix_frame, text="سادة", variable=self.var_sada, anchor="e", justify="right",bg="#FFD65A")
        # chk_sada.pack(side=tk.RIGHT, padx=5)
        # chk_mehaweg = tk.Checkbutton(input_mix_frame, text="محوج", variable=self.var_mehaweg, anchor="e", justify="right" ,bg="#FFD65A")
        # chk_mehaweg.pack(side=tk.RIGHT, padx=5)
        # chk_ispresso = tk.Checkbutton(input_mix_frame, text="اسبريسو", variable=self.var_ispresso, anchor="e", justify="right" ,bg="#FFD65A")
    ...
    def open_search(self):
        ...
        master_frame.config(bg="#FFD65A")
        master_frame.pack(pady=5, padx=50)
        lbl_cust_id = tk.Label(master_frame, text="رقم العميل", anchor="e", width=12 ,font=("Arial", 16 , "bold")  , fg="#4B352A",bg="#FFD65A" )
        lbl_cust_id.grid(row=0, column=1, padx=5, pady=5)
        self.search_entry_id = tk.Entry(master_frame, justify="right",bg="#FFD65A",width=50)
        self.search_entry_id.grid(row=0, column=0, padx=20, pady=5)
        lbl_cust_name = tk.Label(master_frame, text="اسم العميل", anchor="e", width=12, font=("Arial", 16 , "bold")  , fg="#4B352A",bg="#FFD65A" )
        lbl_cust_name.grid(row=1, column=1, padx=5, pady=5)
        self.search_entry_name = tk.Entry(master_frame, justify="right",bg="#FFD65A",width=50 )
        self.search_entry_name.grid(row=1, column=0, padx=5, pady=5)
        lbl_cust_phone = tk.Label(master_frame, text="رقم التليفون", anchor="e", width=12,font=("Arial", 16 , "bold")  , fg="#4B352A",bg="#FFD65A")
        lbl_cust_phone.grid(row=2, column=1, padx=5, pady=5)
        self.search_entry_phone = tk.Entry(master_frame, justify="right" ,bg="#FFD65A",width=50)
        self.search_entry_phone.grid(row=2, column=0, padx=5, pady=5)
        lbl_cust_employer = tk.Label(master_frame, text="اسم الموظف", anchor="e", width=12, font=("Arial", 16 , "bold")  , fg="#4B352A",bg="#FFD65A")
        lbl_cust_employer.grid(row=3, column=1, padx=5, pady=5)
        self.search_entry_employer = tk.Entry(master_frame, justify="right",bg="#FFD65A",width=50 )
